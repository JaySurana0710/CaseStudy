...
public class Ticket {
    ...
    public void insertIntoTicketTable() {
        ...
        try {
            ...
            String query = "insert into TICKET(pnr,train_no,train_name,train_source,train_destination,travel_date,no_of_passengers,total_fare) values (?,?,?,?,?,?,?,?)";
            PreparedStatement pstm = con.prepareStatement(query);
            ...
            pstm.setDouble(8,totalTicketPrice());
